...
with open(
    os.path.join(os.path.dirname(__file__), "evaluator_instructions_1loop.txt"), encoding="utf-8"
) as fd:
    S = fd.read()
...
g = load_func("1loop.sjb")

print(g.evaluate_complex(samples[None, :]).sum())

print("(0.024937137151788233+0.046784164071217244j) is the expectation.")
